...
router.put('/:username', valide_token_1.default, (0, verify_rol_1.default)("admin"), user_1.updateUser);
router.delete("/:username", valide_token_1.default, (0, verify_rol_1.default)("admin"), user_1.deleteUser);
router.put("/login/:username", valide_token_1.default, (0, verify_rol_1.default)("user"), user_1.changePassword);
