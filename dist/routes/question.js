...
router.post("/", valide_token_1.default, question_1.newQuestion);
// Ruta para actualizar una pregunta existente
router.put("/:id", valide_token_1.default, question_1.updateQuestion);
// Ruta para eliminar una pregunta existente
router.delete("/:id", valide_token_1.default, question_1.deleteQuestion);
